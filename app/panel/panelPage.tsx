...
const ALLOWED_EMAILS = ["juan.perez@sucursal.com", "marcosteven0717@gmail.com"];
...
export default function PanelPage({ usuarios }: PanelPageProps) {
  ...
  useEffect(() => {
    try {
      ...
      if (!empleado?.correo || !ALLOWED_EMAILS.includes(empleado.correo.toLowerCase())) {
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row items-start justify-between gap-4">
              ...
              <button
                ...
                className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 border border-green-600 text-sm font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 gap-2 transition-all duration-200"
              >
