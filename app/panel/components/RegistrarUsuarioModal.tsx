...
<div className="px-6 py-4 border-t border-white/10 bg-white/5 backdrop-blur-md">
  <div className="flex justify-end gap-3">
    ...
    <button
      type="button"
      onClick={onClose}
      className="px-5 py-2.5 text-sm font-medium text-gray-300 
    ...
    >
      {isSubmitting ? (
        ...
        <>
          <span className="mr-2">Registrar Usuario</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
